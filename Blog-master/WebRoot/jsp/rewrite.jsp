    ...
    <form class="layui-form layui-form-pane"  action="servlet/WriteTitServlet" method="post">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" lay-verify="required" value="${requestScope.draft.articleTitle}" id="title1" name="article" autocomplete="off" placeholder="请输入标题" class="layui-input">
            </div>
        </div>
        <%--	  <p>文章标题：--%>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="content" lay-verify="required"  value="${requestScope.draft.articleContent}" id="myEditor"></textarea>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
					<input name="summary" lay-verify="required" value="${requestScope.draft.summary}" id="sy" rows="5" cols="40" class="layui-textarea">
	  </input>
            </div>
        </div>
        <%--			<br/>--%>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="data" value="${requestScope.draft.articleDate}" lay-verify="required" id="date1" autocomplete="off" class="layui-input">
            </div>
        </div>
        <%--	  <br/><br/>--%>
        <%--	       写作日期:--%>
...
<script>
    function start() {
        UE.getEditor('myEditor').setContent("${requestScope.draft.articleContent}")
    }
    function draft(){
