...
@WebServlet("/ArticleBrowseHistory")
public class ArticleBrowseHistoryServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        list = articleDao.showArticles(idd);
        request.setAttribute("browseHistory",list);
        System.out.println(list);
        request.getRequestDispatcher("/jsp" +
                "/browsing_history.jsp").forward(request,response);
    }
